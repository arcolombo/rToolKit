...
#' @import edgeR
#' @export
moduleWiseAnalysis<-function(kexp,lnames,rnames,wgcnaDbName="wgcnaDbLite.cpm.sqlite",wrcnaDbName="wrcnaDbLite.cpm.sqlite",qusageDbName="qusageDbLite.cpm.sqlite", geneModules=c("darkturquoise","red","grey60","pink","darkred","royalblue","green","magenta","brown"),repeatModules=c("blue","brown","grey","turquoise"),read.cutoff=2,how=c("cpm","tpm"),enrichmentCaller=c("go","qusage"),comparison1="phsc",comparison2="blast" ){
  ...
  goEnrich<-wgcna_goEnrich(lnames)
  print(goEnrich[which(goEnrich$module==geneModules),])
  readkey()
  } 
