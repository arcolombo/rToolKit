...
patientWiseAnalysis<-function(kexp,topNames=NULL,topDE=NULL,whichDE=c("cqn","poissonSeq","limma"),comparison="LSC",control="pHSC",whichDelta=c("delta1","delta2"),patientID="SU353", orderDE=TRUE){
